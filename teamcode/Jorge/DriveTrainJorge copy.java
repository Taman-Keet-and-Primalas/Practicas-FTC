...
public class DriveTrainJorge extends OpMode{
    ...
    public void init() {
        ...
        System.out.println("It started DT");

        llantas = new DriveTrain(hardwareMap, gamepad1);
        brazo = new ArmServo(hardwareMap, gamepad1);

        System.out.println("It finished DT");
    ...
    public void loop() {
        brazo.moverServo();
        llantas.conducirPOV(-gamepad1.left_stick_y, -gamepad1.right_stick_x);
